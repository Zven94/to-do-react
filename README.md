...
This is our Microverse **To-Do List Project** site, featuring an Art Gallery using HTML, CSS and React.js.
The site is a SPA, it's a **Create a To-Do list**. This app is aviable to solve every math calculation like: addition, substraction, multiplication and division.
